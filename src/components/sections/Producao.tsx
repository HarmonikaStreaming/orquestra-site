          ...
          <div className="card-glass p-6">
            <div className="grid grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col gap-4">
                <p className="text-sm text-ol-slate leading-relaxed text-right">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 rounded-xl px-5 py-3 text-sm font-bold text-white transition-all duration-200 hover:opacity-90 hover:-translate-y-0.5"
