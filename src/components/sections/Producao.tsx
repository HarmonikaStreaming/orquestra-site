    ...
    <section id="producao" className="section bg-ol-surface">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="text-center mb-12 space-y-4">
          <div className="badge mx-auto">Acrescente os serviços de uma produtora audiovisual para potencializar a qualidade e os resultados do seu evento</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            {/* Texto de serviço */}
            <div className="card-glass p-6 w-full text-center">
            ...
            <div className="flex flex-col w-full gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/20 px-6 py-3 text-sm font-semibold text-white transition-all duration-200 hover:border-white/40 hover:bg-white/5"
              >
